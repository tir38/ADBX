...
def print_manual
  ...
  puts '   clear_app_data --package [package]:   clear app data, including cache and accepted permissions'
  ...
  puts '   launch_app --package [package]:  launch a specific application by package name'
  ...
  puts '   permissions --package [package]: list permissions for package (highlighted in larger dumpsys)'
  ...
  puts '   shared_prefs list --package [package]:    lists all shared prefs files for a package'
  puts '   shared_prefs list [filename] --package [package]:    lists contents of a single shared prefs file for a package'
  puts '   shared_prefs remove [filename] [pref name] --package [package]:    removes a single pref from a single shared pref file for a package'
  puts '   talkback [on|off]:      turn Talkback on or off'
  puts '   uninstall_package --package [package]: remove installed package'
  puts '   version_name --package [package]: print package version name'
end
