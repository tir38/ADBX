_ax_completions() 
{
    ...
    primary_opts="add_wifi clear_app_data disable_audio launch_app layout_bounds list_packages help max_bright night_mode permissions pull_apks reboot screenshot, settings_app uninstall_package version_name"
